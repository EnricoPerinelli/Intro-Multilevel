...
Other predictors can be centered as usual (see previous slide).  

Instead, in the context of DSEM M\textit{plus} automatically applies the latent centering approach (see McNeish \& Hamaker, 2020).
:::
...
\vspace{0.2cm}
For a comprehensive treatment of multilevel modeling in R, see \textcolor{blue}{Finch and Bolin (2024)}.
...
\begin{itemize}
  ...
  \item Finch, W. H., \& Bolin, J. E. (2024). \textit{Multilevel modeling using R} (3rd ed.). Chapman and Hall/CRC.
